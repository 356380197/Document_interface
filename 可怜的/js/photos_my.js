...
//			        var img =document.createElement("img");
                    var img2= imgmap[el.getAttribute('href')];
...
//		            console.log(img.width);			        
			        item = {
						...
						w: parseInt(img2.width, 10),
						h: parseInt(img2.height, 10),
...
//						h: parseInt(size[1], 10),
					...
					var mediumSrc = el.getAttribute('data-med');
		          	if(mediumSrc) {
		            	...
		            	// "medium-sized" image
//		            	var img2= imgmap[el.getAttribute('data-med')+""];
		            	var img2 =document.createElement("img");
			        	img2.src = el.getAttribute('data-med');
		            	item.m = {
		              		src: mediumSrc,
		              		w: parseInt(img2.width, 10),
		              		h: parseInt(img2.height, 10)
